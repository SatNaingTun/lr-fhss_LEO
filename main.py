...
def get_simdata(v):
    ...
    use_earlydecode = False      # early decode mechanisms flag
    use_earlydrop = False        # early drop mechanisms flag
...
def get_simdata2(v, numDecoders, use_earlydecode, use_earlydrop):
...
def runsim2csv(numDecoders, use_earlydecode, use_earlydrop, filename):
    ...
    for nodes in netSizes:
        x = get_simdata2(nodes, numDecoders, use_earlydecode, use_earlydrop)
        results.append([nodes] + x)
...
if __name__ == "__main__":
    # runsim()
    runsim2csv(100, False, False, "headerResults/snt/100_base.csv")
    runsim2csv(100, True, True, "headerResults/snt/100_early.csv")

    # 1000 demodulators
    runsim2csv(1000, False, False, "headerResults/snt/1000_base.csv")
    runsim2csv(1000, True, True, "headerResults/snt/1000_early.csv")

    # infinity (large number)
    runsim2csv(20000, False, False, "headerResults/snt/inf_base.csv")
    runsim2csv(20000, True, True, "headerResults/snt/inf_early.csv")